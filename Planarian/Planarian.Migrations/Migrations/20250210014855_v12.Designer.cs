...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planarian.Model.Database.Entities.RidgeWalker.CavePermission", b =>
                {
                    ...
                    b.HasIndex("UserId", "AccountId", "CaveId")
                        .IsUnique()
                        .HasFilter("\"CaveId\" IS NOT NULL");

                    b.HasIndex("UserId", "AccountId", "CountyId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Planarian.Model.Database.Entities.RidgeWalker.CavePermissionPermission", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<string>("CavePermissionId")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
                    ...
                    b.HasIndex("CavePermissionId");

                    b.HasIndex("PermissionId");

                    b.ToTable("CavePermissionPermissions");
                });
            ...
            modelBuilder.Entity("Planarian.Model.Database.Entities.RidgeWalker.CavePermissionPermission", b =>
                {
                    b.HasOne("Planarian.Model.Database.Entities.RidgeWalker.CavePermission", "CavePermission")
                        .WithMany("CavePermissionPermissions")
                        .HasForeignKey("CavePermissionId")
            ...
            modelBuilder.Entity("Planarian.Model.Database.Entities.RidgeWalker.Permission", b =>
                {
                    b.HasOne("Planarian.Model.Database.Entities.RidgeWalker.CavePermission", null)
            ...
            modelBuilder.Entity("Planarian.Model.Database.Entities.RidgeWalker.CavePermission", b =>
                {
                    b.Navigation("CavePermissionPermissions");
