                    ...
                    b.OwnsOne("Planarian.Model.Database.Entities.RidgeWalker.ViewModels.AddCave", "Json", b1 =>
                        {
                            ...
                            b1.Property<string[]>("AlternateNames")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.Property<string[]>("ArcheologyTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.Property<string[]>("BiologyTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.Property<string[]>("CartographerNameTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");
                            ...
                            b1.Property<string[]>("GeologicAgeTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.Property<string[]>("GeologyTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");
                            ...
                            b1.Property<string[]>("MapStatusTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");
                            ...
                            b1.Property<string[]>("OtherTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.Property<string[]>("PhysiographicProvinceTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");
                            ...
                            b1.Property<string[]>("ReportedByNameTagIds")
                                .IsRequired()
                                .HasColumnType("text[]");
