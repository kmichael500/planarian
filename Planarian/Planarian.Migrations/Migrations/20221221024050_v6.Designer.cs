...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripObjectiveTripObjectiveType", b =>
                {
                    b.Property<string>("TripObjectiveTypesId")
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("TripObjectivesId")
                        .HasColumnType("nvarchar(10)");

                    b.HasKey("TripObjectiveTypesId", "TripObjectivesId");

                    b.HasIndex("TripObjectivesId");

                    b.ToTable("TripObjectiveTripObjectiveType");
                });
            ...
            modelBuilder.Entity("TripObjectiveTripObjectiveType", b =>
                {
                    b.HasOne("Planarian.Model.Database.Entities.TripObjectiveType", null)
                        .WithMany()
                        .HasForeignKey("TripObjectiveTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Planarian.Model.Database.Entities.TripObjectives.TripObjective", null)
                        .WithMany()
                        .HasForeignKey("TripObjectivesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
