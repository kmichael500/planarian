...
public sealed class CaveMutationRepository
{
    ...
    public CaveMutationRepository(PlanarianDbContext db, RequestUser requestUser, CavePublishedSnapshotRepository snapshots)
    {
        _db = db;
