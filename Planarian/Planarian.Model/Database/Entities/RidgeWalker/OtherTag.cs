...
public class OtherTag : EntityBase
{
...
public class OtherTagConfiguration : BaseEntityTypeConfiguration<OtherTag>
{
    public override void Configure(EntityTypeBuilder<OtherTag> builder)
    {
